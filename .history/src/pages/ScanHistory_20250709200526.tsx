...
export default function ScanHistory() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-start py-10 px-4">
      <div className="w-full max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-center" style={{ color: "#FF7F50" }}>
          Scan History
        </h1>
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-muted-foreground mb-6">Try uploading your first artwork to see scan results here.</p>
