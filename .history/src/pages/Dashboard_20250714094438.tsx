              ...
              <Card key={scan.id} className="min-w-[280px] sm:min-w-[260px] max-w-xs flex-shrink-0 rounded-2xl shadow-md bg-[#F9F6F2] flex flex-col">
                <CardHeader className="p-0 relative">
                  <img
                    src={scan.image_url}
                    alt={scan.label}
                    className="w-full h-32 sm:h-36 object-cover rounded-t-2xl"
                  />
                ...
                <CardContent className="pt-3 flex-1 flex flex-col p-4">
                  <div className="font-bold text-base sm:text-lg mb-1">{Math.round(scan.confidence * 100)}% Confidence</div>
          ...
          <Card className="w-full max-w-xl mx-auto">
            <CardContent className="flex flex-col gap-4 p-4 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <span className="text-xs sm:text-sm">4,250 / 10,000</span>
              </div>
              <Button className="self-end w-full sm:w-auto" variant="default">Upgrade Plan</Button>
            </CardContent>
          </Card>
        </section>
        ...
        <Dialog open={showFeedback} onOpenChange={setShowFeedback}>
          ...
          <DialogContent className="w-[90vw] max-w-md mx-auto">
            ...
            <form className="flex flex-col gap-4 mt-4">
              <textarea className="border rounded p-2 min-h-[80px] w-full" placeholder="Type your message..." />
